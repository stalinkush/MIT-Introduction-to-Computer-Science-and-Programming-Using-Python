...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) != 0:
        ...
        displayHand(hand) 
        # Ask user for input
        in_letter = input('Enter word, or a "." to indicate that you are finished: ')
        ...
        if not isValidWord(in_letter, hand, wordList):
            ...
            # Otherwise (the word is valid):
             ...
             score = getWordScore(in_letter, n)
             total_score += score
             print('"{} earned {} points. Total: {} points'.format(in_letter, score, total_score))
                # Update the hand 
             hand = updateHand(hand, in_letter) 
...
def playGame(wordList):
    ...
    while True:
        ...
        if user_input == 'n':
            ...
            while True:
                try:
                    HAND_SIZE = int(input('Enter the hand length you want to play: '))
                    break
                except:
